...
export class ChatService {
  ...
  deleteChat(chatId:any){
    // deleteChat/{id}
    return this.httpClient.delete(this.baseUrl + "/chats/deleteChat/" + chatId)
  }

  deleteMessage(msgId:any)
  {
    return this.httpClient.delete(this.baseUrl + "/chats/deletemsg/" + msgId)
  }

  editMessage(msgId:any, body:string)
  {
    return this.httpClient.post(this.baseUrl + "/chats/updatemsg/"+ msgId, body );
  }
