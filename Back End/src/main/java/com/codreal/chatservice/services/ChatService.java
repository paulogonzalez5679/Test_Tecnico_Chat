...
public interface ChatService {
    ...
    List<Message> getAllMessagesInChat(int chatId) throws NoChatExistsInTheRepository;
     ...
     void Delete(int chatId) throws  ChatNotFoundException;

     void deleteMessage(int id_msg)  throws ChatNotFoundException;

    void updateMessage(int id_msg, String replymessage)  throws ChatNotFoundException;
