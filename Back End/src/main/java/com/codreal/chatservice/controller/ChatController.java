...
public class ChatController {
    ...
    public ResponseEntity<?> deleteMessage(@PathVariable int idmsg) {
        try {
            this.chatService.deleteMessage(idmsg);
            return new ResponseEntity<>(HttpStatus.OK);
        } catch (ChatNotFoundException e) {
            return new ResponseEntity("Chat Not Found", HttpStatus.NOT_FOUND);
        }
    ...
    @PostMapping("/updatemsg/{idmsg}")
    public ResponseEntity<?> updateMessage(@PathVariable int idmsg, @RequestBody String replymessage) {
        try {
           this.chatService.updateMessage(idmsg, replymessage);
            return new ResponseEntity<>(HttpStatus.OK);
        } catch (ChatNotFoundException e) {
            return new ResponseEntity("Chat Not Found", HttpStatus.NOT_FOUND);
        }
